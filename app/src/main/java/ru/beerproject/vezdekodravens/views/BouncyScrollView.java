package ru.beerproject.vezdekodravens.views;
...
import ru.beerproject.vezdekodravens.R;
...
public class BouncyScrollView extends ScrollView {
    ...
    public BouncyScrollView(Context context, AttributeSet attrs, int defStyle) {
